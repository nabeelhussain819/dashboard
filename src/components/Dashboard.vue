            ...
            <div class="w-100 items-end justify-end flex">
              <a-tooltip placement="top">
                ...
                <a-dropdown v-model:open="visible">
                  ...
                  <template #overlay>
                    <a-menu v-on:click="handleMenuClick" >
                      <a-menu-item key="1">Clothes.</a-menu-item>
                      <a-menu-item key="2">Electronic Items.</a-menu-item>
                      <a-menu-item key="3">Groceries</a-menu-item>
                    </a-menu>
                  </template>
                </a-dropdown>
              </a-tooltip>
